...
get_results<- function(lambda){
  ...
  for (q in 1:100){
    ...
    frame1 <-data.frame(V1=coefs_lm[2], V2=coefs_lm[3],V3=coefs_lm[4], V4=coefs_lm[5],V5=
                                 coefs_lm[6],method="lm")
    frame2 <-data.frame(V1=coefs_rd[2], V2=coefs_rd[3],V3=coefs_rd[4], V4=coefs_rd[5],V5=
                                 coefs_rd[6],method="ridge")
