...
data       <- read.csv("/Users/fjuretig/Documents/metals.csv")
...
m3       <- train(metal_strength~., data=combined_train_data, method="svmLinear",preProcess=c("medianImpute","scale","center")
                  ,metric="RMSE", tuneGrid=tunegrid, trControl=control)
